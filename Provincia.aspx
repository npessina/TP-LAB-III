<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Provincia.aspx.vb" Inherits="Provincia" %>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="jumbotron padding-modificado">
                        ...
                        <h2><strong>Nueva provincia</strong></h2>
                        <br />
                        <div class="row">
                            <div class="col-md-12">
                ...
                <div class="col-md-8">
                    <div class="jumbotron padding-modificado">
                        <h2><strong>Listado de provincias</strong></h2>
                        <br />
                        <div class="row">
                            <div class="col-md-12">
                                <div class="scroll">
                                        ...
                                        <asp:Repeater ID="Repeater1" runat="server">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td><a href="ModificarProvincia.aspx?id=<%#Container.DataItem("idProvincia")%>">MODIFICAR </a></td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                    </table>
