<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ModificarEnvio.aspx.vb" Inherits="ModificarEnvio" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div class="jumbotron padding-modificado">
                ...
                <h2><strong>Modificar envío</strong></h2>
                <br />
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <asp:Label ID="Label2" runat="server" Text="Fecha"></asp:Label><br />
                    ...
                    <div class="col-md-6">
                        <asp:Label ID="Label3" runat="server" Text="Precio Total"></asp:Label><br />
                        <asp:TextBox ID="TxtPrecioTotal" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="grupo1" runat="server" ControlToValidate="TxtPrecioTotal" ErrorMessage="Falta campo Precio Total" Display="None" BorderStyle="NotSet"></asp:RequiredFieldValidator>
                    </div>
                    <div class="col-md-6">
