...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container ancho-minimo">
            <div class="jumbotron centrado padding-modificado">
                <h1><strong>SISTEMA DE GESTIÓN</strong></h1>
                <h1><strong>VENTA DE CELULARES</strong></h1>
                <img src="imagenes/tienda.jpg" class="img-fluid"/>
            </div>
        </div>

        <div class="footer" style="height: 40px; margin-top: 288px; background-color: black;">
            <p style="color: white; font-size: 15px"><strong>&nbsp; Contacto: Telefono: 03492-667929 - Correo: nico.pessina7@gmail.com</strong></p>
        </div>
